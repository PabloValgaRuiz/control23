...
public:
    ...
    const std::vector<int>& getOrgS() const {return totalOrgS;}
    const std::vector<int>& getDesS() const {return totalDesS;}
    const std::vector<int>& getOrgI() const {return totalOrgI;}
    const std::vector<int>& getDesI() const {return totalDesI;}

    const std::vector<int>& getOrgE() const {return totalOrgE;}
    const std::vector<int>& getDesE() const {return totalDesE;}
    const std::vector<int>& getOrgR() const {return totalOrgR;}
    const std::vector<int>& getDesR() const {return totalDesR;}
